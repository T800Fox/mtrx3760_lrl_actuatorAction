...
def generate_launch_description():
    ...
    world = os.path.join(
        get_package_share_directory('mtrx3760_oogway_mazesolver'),
        'worlds',
        'maze04.world'
    )
    ...
    # Bridge for camera image from Gazebo to ROS2
    # Maps Gazebo topic /camera/image_raw to ROS2 topic /camera/image_raw
    camera_bridge = Node(
